<h4 id="{{ include.carrier_interface | slugify }}---disposable-pallet">Disposable pallet</h4>
...
<a class="btn btn-primary" type="button" data-toggle="collapse" data-target="#{{include.carrier_interface}}_package_type_disposable_pallet_togglebox" aria-expanded="false" aria-controls="collapseExample">
  Show example
</a>

<div id="{{include.carrier_interface}}_package_type_disposable_pallet_togglebox" class="panel-collapse collapse">
<div class="well">
{% highlight http %}
