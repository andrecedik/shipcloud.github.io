...
<a class="btn btn-primary" type="button" data-toggle="collapse" data-target="#{{include.carrier_interface}}_delivery_time_togglebox" aria-expanded="false" aria-controls="collapseExample">
  Show example
</a>

<div id="{{include.carrier_interface}}_delivery_time_togglebox" class="panel-collapse collapse">
<div class="well">
{% highlight http %}
